...
{
 "use strict";
 var abdoCalc,Client,WebSharper,Obj,UI,HtmlModule,attr,Operators,Arrays,Templating,Runtime,Server,TemplateInstance,ProviderBuilder,Unchecked,abdoCalc_Templates,AttrProxy,Doc,Elt,JavaScript,Pervasives,AttrModule,System,Guid,Collections,List,Handler,Client$1,Templates,Attrs,DomUtility,View,Dictionary,HashSet,Seq,TemplateInitializer,Var$1,EventTarget,Node,JS,Updates,Snap,Numeric,Object,Var,CheckedInput,DictionaryUtil,Enumerator,T,ConcreteVar,SC$1,WindowOrWorkerGlobalScope,Docs,Array,DocElemNode,CharacterData,Abbrev,Fresh,Prepare,Slice,KeyCollection,An,Settings,Mailbox,List$1,T$1,Attrs$1,Dyn,Strings,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$2,HashSetUtil,SC$3,SC$4,BindVar,SC$5,SC$6,AppendList,String,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,Char,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,Math,console,Date;
 abdoCalc=Global.abdoCalc=Global.abdoCalc||{};
 Client=abdoCalc.Client=abdoCalc.Client||{};
 ...
 abdoCalc_Templates=Global.abdoCalc_Templates=Global.abdoCalc_Templates||{};
 ...
 Client.Main=function()
 {
  ...
  function btn(caption,action)
  {
   return Doc.Element("button",[AttrModule.Handler("click",function()
   {
    return function()
    {
     return action();
  ...
  calculator=Doc.Element("div",[],[display,Doc.Element("br",[],[]),Doc.Element("div",[],[digit(7),digit(8),digit(9),btn("/",function($5)
  {
   return O(function($6)
   {
    return function($7)
  ...
  }),Doc.Element("br",[],[]),digit(4),digit(5),digit(6),btn("*",function($5)
  {
   return O(function($6)
   {
    return function($7)
  ...
  }),Doc.Element("br",[],[]),digit(1),digit(2),digit(3),btn("-",function($5)
  {
   return O(function($6)
   {
    return function($7)
  ...
  }),Doc.Element("br",[],[]),digit(0),btn("C",function()
  {
   num=0;
   updateDisplay();
  }),btn("AC",function()
  ...
  a=(b=(_this=new ProviderBuilder.New$1(),(_this.h.push({
   ...
   $0:"main",
   $1:calculator
  }),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],abdoCalc_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 abdoCalc_Templates.main=function(h)
 {
